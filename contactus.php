...
<html>
<header>
<title>Smart Soft Experts,web designers</title>
<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="website designers">
    <meta name="the scorpions" content="">
    <meta name="keywords" content="smart soft experts contact,">
...
<li><a href="blog.php"  style="color:white">Blog</a></li>
  ...
  <div class="row">
        <div class="col-md-6">
		 ...
		 <?php
				  ...
				  ?>
		<div class="text text- col-md-offset-5">
 ...
 <div class="row">
          <div class="col-md-12">		  
				 ...
				 <div class="col-md-offset-4"><b>
				Mobile No:0707071957</br></br>
				Mobile No:0707071957</br></br>
				Email:info@smartsoftexperts.com</br></br>
				Quick contact:</br></br></b>
				</div>
				 <?php
							...
							if(mail($to,$subject,$body,$header))
							  {
							   ...
							   echo "<div id=\"err-alert\" class=\"alert alert-danger fade in \">
					<a href=\"login.php\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\" > &times;
					</a> Your message has been sent successfuly! 
				</div>"
							   ;
							  } else {
							  echo "<div id=\"err-alert\" class=\"alert alert-danger fade in \">
					<a href=\"login.php\" class=\"close\" data-dismiss=\"alert\" aria-hidden=\"true\" > &times;
					</a> Sorry! an error occured. try again 
				</div>";
							  }
				...
				<form method="POST" action="contactus.php" role="form">
					  ...
					  <div class="form-group">
					        <input type="number" name="phone" class="form-control" placeholder="Enter your mobile number eg 0707195657"/>
					  </div>
					  <textarea class="form-control" name="message" type="text" placeholder="Enter your comment" rows="6"></textarea></br></br></br></br>
