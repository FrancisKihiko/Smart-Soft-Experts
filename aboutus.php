...
<html>
<header>
<title>Software development,smart soft experts,mobile apps,web designers</title>
<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="About Smart Soft Experts">
    <meta name="the scorpions" content="">
    <meta name="keywords" content="smartsoftexperts,cheap website,website,software">
    <link rel="icon" href="../../favicon.ico">
	

<meta name="author" content="francis kihiko" />
...
<li><a href="blog.php"  style="color:white">Blog</a></li>
 ...
 <div class="row">
          <div class="col-md-12">		  
		         <div class="col-md-8">
				 Smart Soft Experts is a roberst company that deal with all categories of softwares from  simple website to complex application softwares.We are made up of a team 
				 of experienced and innovative staffs who are ready to learn and implement the latest technology to produce the best for our Clients.</br></br>
				 <div class="panel panel-default">
				     <div class="panel-heading">
					  <b> Mission</b>
					 </div>
					  <div class="panel-body">
					  To be the preeminet provider of business solutions through software applications and improving the quality of our products consistently.
					  To ensure longevity of our company through repeate and referral business achieved by customer satisfaction in all 
					  areas including timeliness,attention to detail and service-minded attitude.
					  </div>
				 </div>
				     <div class="panel panel-default">
				     <div class="panel-heading">
					  ...
					  <div class="panel-body">
					  To grow our company through investigeting advancing technology,industry changes and the varying need of our client as our company evolve.</br>To be the leading software company 
					  in Africa.
					  </div>
				 </div>
