...
<html>
<header>
<title>Search Engine Optimization,smart soft experts,software development</title>
<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="What is a search engine optimization">
    <meta name="the scorpions" content="">
    <meta name="keywords" content="Search engine optimization,internet marketing">
...
<li><a href="blog.php"  style="color:white">Blog</a></li>
  ...
  <div class="row">
        <div class="col-md-6">
		 ...
		 <?php
				  ...
				  ?>
		<div class="text text- col-md-offset-4">
 ...
 <div class="row">
          <div class="col-md-12">		  
		         <div class="col-md-8">
				 <p>
				    How many times have you typed into any search engine such as Google and yahoo the term that  best describe your business and been instantly annoyed when you see thausands of results
					but no where yours is found?.We understand how daunting it can be, but you will be surprised at how much rubbish is out there.</p>
				    
					</br>
					<b> First, what is a Search Engine Optimization (SEO)</b></br>
				    Search Engine Optimization is a highly technical process that determine how your website is ranked in search engine index and against your competitors by the search engine.</br></br>
					No matter 
					how much you invest on  your website,Search Engine Optimization is an integral factor of consideration for easy finding of your business and products when potential customers search for
					your business</p></br>
					SEO involes analysing  your business and products and  and coming up with keyphrases and keywords that potential customers are likely to enter into Google when searching for your business.
                    This also need costant checking on what Google and the other Search engines consider a good website and worthy of a good ranking.</br></br>
					<b>Some advantages of SEO are:</b></br>
                    <ol>
					   <li>Place your business on top of google indexing</li>
					   <li>Internent Marketing</li>
					   <li>Increase sales</li>
					   <li> influx of potential customers</li>
					   <li>Gain competitive advantages</li>
					   <li>Discover a new market</li>
					</ol>	
					</br>
...
href="#collapseTwo">
<div class="col-md-offset-3"><b>For more detail and Pricing.</b>Please Click me to expand</div>
</a>
</h4>
</div>
...
<caption> Available packages of Search engine optimization (SEO)</caption>
<thead>
<tr>
<th>Features</th>
<th>basic SEO</th>
...
<td><span class="glyphicon glyphicon-ok">After 2 weeks</span></td>
<td><span class="glyphicon glyphicon-ok">After 1 Week</span></td>
<td><span class="glyphicon glyphicon-ok">After 3 days</span></td>
<td><span class="glyphicon glyphicon-ok">Daily</span></td>
...
<tr>
<td>Google ,yahoo,Bing xml sitemaps</td>
<td><span class="glyphicon glyphicon-">&times;</span></td>
<td><span class="glyphicon glyphicon-ok">5</span></td>
<td><span class="glyphicon glyphicon-ok">10</span></td>
<td><span class="glyphicon glyphicon-ok">Unlimited site map submission</span></td>
</tr>
<tr>
<td>Embedding Google Maps</td>
<td><span class="glyphicon glyphicon-">&times;</span></td>
<td><span class="glyphicon glyphicon-">&times;</span></td>
<td><span class="glyphicon glyphicon-ok"></span></td>
<td><span class="glyphicon glyphicon-ok"></span></td>>
...
<tr>
<td>Body,image tag optimization</td>
<td><span class="glyphicon glyphicon-ok"></span></td>
<td><span class="glyphicon glyphicon-ok"></span></td>
<td><span class="glyphicon glyphicon-ok"></span></td>
<td><span class="glyphicon glyphicon-ok"></span></td>
...
<tr>
<td><b>Price</b></td>
<td><b>Ksh. 2000/pm</b></td>
<td><b>Ksh. 4000/pm</b></td>
<td><b>Ksh. 6000/pm</b></td>
<td><b>Ksh. 8000/pm</b></td>
